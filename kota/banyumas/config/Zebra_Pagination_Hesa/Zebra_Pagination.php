...
class Zebra_Pagination
{
     ...
     */
       ...
       public function render($return_output = false,$variable_1,$value_1,$variable_2,$value_2)
    {
        ...
        $output = '<div class="Zebra_Pagination"><ul class="pagination info">';
        ...
        if ($this->_properties['reverse']) {
            ...
            if ($this->_properties['navigation_position'] == 'left'){
                ...
                $output .= $this->_show_next($variable_1,$value_1,$variable_2,$value_2) . $this->_show_previous($variable_1,$value_1,$variable_2,$value_2) . $this->_show_pages($variable_1,$value_1,$variable_2,$value_2) ;
            }
            ...
            elseif ($this->_properties['navigation_position'] == 'right'){
                ...
                $output .= $this->_show_pages($variable_1,$value_1,$variable_2,$value_2) . $this->_show_next($variable_1,$value_1,$variable_2,$value_2) . $this->_show_previous($variable_1,$value_1,$variable_2,$value_2) ;

            }
            // if "next page" and "previous page" links are to be shown on the outside of the links to individual pages
            else { $output .= $this->_show_next($variable_1,$value_1,$variable_2,$value_2) . $this->_show_pages($variable_1,$value_1,$variable_2,$value_2) . $this->_show_previous($variable_1,$value_1,$variable_2,$value_2) ; }
        ...
        // if we're showing records in natural order
            ...
            if ($this->_properties['navigation_position'] == 'left')
                ...
                // first show next/previous and then page links
                $output .= $this->_show_previous($variable_1,$value_1,$variable_2,$value_2) . $this->_show_next($variable_1,$value_1,$variable_2,$value_2) . $this->_show_pages($variable_1,$value_1,$variable_2,$value_2);

            // if "next page" and "previous page" links are to be shown to the right of the links to individual pages
            elseif ($this->_properties['navigation_position'] == 'right')

                $output .= $this->_show_pages($variable_1,$value_1,$variable_2,$value_2) . $this->_show_previous($variable_1,$value_1,$variable_2,$value_2) . $this->_show_next($variable_1,$value_1,$variable_2,$value_2);

            // if "next page" and "previous page" links are to be shown on the outside of the links to individual pages
            else $output .= $this->_show_previous($variable_1,$value_1,$variable_2,$value_2) . $this->_show_pages($variable_1,$value_1,$variable_2,$value_2) . $this->_show_next($variable_1,$value_1,$variable_2,$value_2);
     ...
     *  @access private
     */
    private function _show_next($variable_1,$value_1,$variable_2,$value_2)
    {
        ...
        if ($this->_properties['always_show_navigation'] || $this->_properties['total_pages'] > $this->_properties['selectable_pages'])
            ...
            $output = '<li' . ($this->_properties['page'] == $this->_properties['total_pages'] ? ' class="disabled"' : '') . '><a href="' .
                ...
                ($this->_properties['page'] == $this->_properties['total_pages'] ? 'javascript:void(0)' : $this->_build_uri($this->_properties['page'] + 1)) . '&'.$variable_1.'='.$value_1. '&'.$variable_2.'='.$value_2.
     ...
     *  @access private
     */
    private function _show_pages($variable_1,$value_1,$variable_2,$value_2)
    {
        ...
        if ($this->_properties['total_pages'] <= $this->_properties['selectable_pages']) {
            ...
            for (
                ...
                $output .= '<li' . ($this->_properties['page'] == $i ? ' class="active"' : '') . '><a href="' . $this->_build_uri($i) . '&'.$variable_1.'='.$value_1.'&'.$variable_2.'='.$value_2.' ">' .
        ...
        // if the total number of pages is greater than the number of selectable pages
            ...
            $output .= '<li' . ($this->_properties['page'] == ($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) ? ' class="active"' : '') . '><a href="' . $this->_build_uri($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) . '&'.$variable_1.'='.$value_1.'&'.$variable_2.'='.$value_2.'">' .
            ...
            for ($i = $starting_page; $this->_properties['reverse'] ? $i >= $ending_page : $i <= $ending_page; $this->_properties['reverse'] ? $i-- : $i++)
                ...
                $output .= '<li' . ($this->_properties['page'] == $i ? ' class="active"' : '') . '><a href="' . $this->_build_uri($i) . '&'.$variable_1.'='.$value_1.'&'.$variable_1.'='.$value_2.'">' .
            ...
            $output .= '<li' . ($this->_properties['page'] == $i ? ' class="active"' : '') . '><a href="' . $this->_build_uri($this->_properties['reverse'] ? 1 : $this->_properties['total_pages']) . '&'.$variable_1.'='.$value_1.'&'.$variable_2.'='.$value_2.'">' .
     ...
     *  @access private
     */
    private function _show_previous($variable_1,$value_1,$variable_2,$value_2)
    {
        ...
        if ($this->_properties['always_show_navigation'] || $this->_properties['total_pages'] > $this->_properties['selectable_pages'])
            ...
            $output = '<li' . ($this->_properties['page'] == 1 ? ' class="disabled"' : '') . '><a href="' .
                ...
                ($this->_properties['page'] == 1 ? 'javascript:void(0)' : $this->_build_uri($this->_properties['page'] - 1)) . '&'.$variable_1.'='.$value_1.'&'.$variable_2.'='.$value_2.
