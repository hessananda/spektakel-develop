...
$now = date("Y-m-d H:i:s");
 ...
 mysqli_query($con,"INSERT INTO event_organizer_draft VALUES ('',
 										'$eo_name',
 										'$eo_contact_name',
 										'$eo_contact_number',
 										'$eo_email',
 ...
 $eo = mysqli_fetch_assoc(mysqli_query($con,"SELECT eo_id FROM event_organizer_draft WHERE eo_name = '$eo_name' 
...
$event_finish_time = $event_finish_time_hour.':'.$event_finish_time_minute.':'.'00' ;
 ...
 mysqli_query($con,"INSERT INTO event_draft VALUES ('',
 										'$event_title',
 										'$event_start_date',
 										'$event_finish_date',
 										'$event_start_time',
