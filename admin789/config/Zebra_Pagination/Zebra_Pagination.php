...
class Zebra_Pagination
{
     ...
     *  @return void
     */
    public function render($return_output = false,$variable,$value)
    {
        ...
        if ($this->_properties['reverse']) {
            ...
            if ($this->_properties['navigation_position'] == 'left')
                ...
                $output .= $this->_show_next($variable,$value) . $this->_show_previous($variable,$value) . $this->_show_pages($variable,$value);
            ...
            elseif ($this->_properties['navigation_position'] == 'right')
                ...
                $output .= $this->_show_pages($variable,$value) . $this->_show_next($variable,$value) . $this->_show_previous($variable,$value);

            // if "next page" and "previous page" links are to be shown on the outside of the links to individual pages
            else $output .= $this->_show_next($variable,$value) . $this->_show_pages($variable,$value) . $this->_show_previous($variable,$value);
        ...
        // if we're showing records in natural order
            ...
            if ($this->_properties['navigation_position'] == 'left')
                ...
                // first show next/previous and then page links
                $output .= $this->_show_previous($variable,$value) . $this->_show_next($variable,$value) . $this->_show_pages($variable,$value);

            // if "next page" and "previous page" links are to be shown to the right of the links to individual pages
            elseif ($this->_properties['navigation_position'] == 'right')

                $output .= $this->_show_pages($variable,$value) . $this->_show_previous($variable,$value) . $this->_show_next($variable,$value);

            // if "next page" and "previous page" links are to be shown on the outside of the links to individual pages
            else $output .= $this->_show_previous($variable,$value) . $this->_show_pages($variable,$value) . $this->_show_next($variable,$value);
     ...
     *  @access private
     */
    private function _show_next($variable,$value)
    {
        ...
        if ($this->_properties['always_show_navigation'] || $this->_properties['total_pages'] > $this->_properties['selectable_pages'])
            ...
            $output = '<li' . ($this->_properties['page'] == $this->_properties['total_pages'] ? ' class="disabled"' : '') . '><a href="' .
                ...
                ($this->_properties['page'] == $this->_properties['total_pages'] ? 'javascript:void(0)' : $this->_build_uri($this->_properties['page'] + 1)) . '&'.$variable.'='.$value.'"' .
     ...
     *  @access private
     */
    private function _show_pages($variable,$value)
    {
        ...
        if ($this->_properties['total_pages'] <= $this->_properties['selectable_pages']) {
            ...
            for (
                ...
                $output .= '<li' . ($this->_properties['page'] == $i ? ' class="active"' : '') . '><a href="' . $this->_build_uri($i) . '&'.$variable.'='.$value.'">' .
        ...
        // if the total number of pages is greater than the number of selectable pages
            ...
            $output .= '<li' . ($this->_properties['page'] == ($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) ? ' class="active"' : '') . '><a href="' . $this->_build_uri($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) . '&'.$variable.'='.$value.'">' .
            ...
            $output .= '<li' . ($this->_properties['page'] == $i ? ' class="active"' : '') . '><a href="' . $this->_build_uri($this->_properties['reverse'] ? 1 : $this->_properties['total_pages']) . '&'.$variable.'='.$value.'">' .
     ...
     *  @access private
     */
    private function _show_previous($variable,$value)
    {
        ...
        if ($this->_properties['always_show_navigation'] || $this->_properties['total_pages'] > $this->_properties['selectable_pages'])
            ...
            $output = '<li' . ($this->_properties['page'] == 1 ? ' class="disabled"' : '') . '><a href="' .
                ...
                ($this->_properties['page'] == 1 ? 'javascript:void(0)' : $this->_build_uri($this->_properties['page'] - 1)) . '&'.$variable.'='.$value.'"' .
