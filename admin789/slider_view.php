				...
				<div class="container-fluid">
					...
					<div class="the-box">
						...
						<table class="table table-striped table-hover" id="datatable-example">
							...
							<tbody>
								<?php
									$users = mysql_query("SELECT * from slider ORDER BY slider_id DESC ");
									$no = 1;
									...
									while ($user = mysql_fetch_assoc($users)) {
										  ...
										  <div class="modal-dialog">
											<div class="modal-content">
											  <div class="modal-header">
												...
												<h4 class="modal-title" id="DefaultModalLabel"><center> Apakah Anda Yakin akan menghapus data <br><b><?php echo $user['slider_title'] ?> </b> ?</center></h4>
											  </div>

											  <div class="modal-footer">
												<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
												<button type="button" class="btn btn-primary" onclick="location.href='slider_action.php?action=hapus&id=<?php echo $user['slider_id'] ?>' " >Hapus</button>
											  </div><!-- /.modal-footer -->
											</div><!-- /.modal-content -->
										  </div><!-- /.modal-doalog -->
										</div><!-- /#DefaultModal -->
										...
										<tr class="odd gradeX">
											...
											<td class="table-danger"><?php echo $user['slider_title'] ?></td>			
											<td><a href="slider_edit.php?id=<?php echo $user['slider_id'] ?>">Edit</a> / <a data-toggle="modal" data-target="#DefaultModal<?php echo $no ?>" href="#" >Hapus</a></td>
										</tr>
