<?php
    ...
    $sql = "SELECT e.*, mem.full_name, eo.* FROM event_draft e
    ...
    $edit_time=strtotime($event['event_edited_time']);
    $input_time=strtotime($event['event_input_time']);
...
<body>
	<div class="wrapper bg-grey">
		...
		<div class="container content">
			<form action="part/post_event_action.php?menu=edit_draft&id=<?php echo $event['event_id'] ?>" method="post" enctype="multipart/form-data">
				<div class="row">
					<div class="col-md-8 col-sm-6 title">
						<h1>Posting Kegiatan <div class="label label-draft">Draft</div></h1>
						<span>Terakhir di simpan pada <?php echo $event['event_edited_time']=='0000-00-00 00:00:00'? tgl_indo(date('Y-m-d', $input_time)).', jam '.date('H:i', $input_time):tgl_indo(date('Y-m-d', $edit_time)).', jam '.date('H:i',$edit_time) ?></span>
					</div>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 form-content">
							...
							<div class="col-md-12">
								...
								<div class="row">
									<div class="box-img-template col-md-15 col-sm-6">
										...
										<span>Budaya</span>
										<input value="template_budaya.jpg" name="template_image" type="checkbox" id="temp-1" class="hidden" <?php echo $event['event_image']=='template_budaya.jpg' ?'selected':'' ; ?> />
									</div>
									<div class="box-img-template col-md-15 col-sm-6">
										<img src="images/events/template_festival.jpg" class="img-responsive img-radio">
										<span>Festival</span>
										<input value="template_festival.jpg" name="template_image" type="checkbox" id="temp-2" class="hidden" <?php echo $event['event_image']=='template_festival.jpg' ?'selected':'' ; ?> />
									</div>
									<div class="box-img-template col-md-15 col-sm-6">
										<img src="images/events/template_film.jpg" class="img-responsive img-radio">
										<span>Film</span>
										<input value="template_film.jpg" name="template_image" type="checkbox" id="temp-3" class="hidden" <?php echo $event['event_image']=='template_film.jpg' ?'selected':'' ; ?> />
									</div>
									<div class="box-img-template col-md-15 col-sm-6">
										<img src="images/events/template_musik.jpg" class="img-responsive img-radio">
										<span>Musik</span>
										<input value="template_musik.jpg" name="template_image" type="checkbox" id="temp-4" class="hidden" <?php echo $event['event_image']=='template_musik.jpg' ?'selected':'' ; ?> />
									</div>
									<div class="box-img-template col-md-15 col-sm-6">
										...
										<?php echo $event['event_image']=='template_olahraga.jpg' ?'selected':'' ; ?> />
									</div>
								...
								<div class="box-img-template col-md-15 col-sm-6">
										...
										<span>Permainan</span>
										<input value="template_permainan.jpg" name="template_image" type="checkbox" id="temp-5" class="hidden" <?php echo $event['event_image']=='template_permainan.jpg' ?'selected':'' ; ?> />
									</div>	
									<div class="box-img-template col-md-15 col-sm-6">
										...
										<?php echo $event['event_image']=='template_pertunjukan.jpg' ?'selected':'' ; ?> />
									</div>
									<div class="box-img-template col-md-15 col-sm-6">
										...
										<?php echo $event['event_image']=='template_tradisi.jpg' ?'selected':'' ; ?> />
									</div>
									<div class="box-img-template col-md-15 col-sm-6">
										<img src="images/events/template_sastra.jpg" class="img-responsive img-radio">
										<span>Sastra</span>
										<input type="checkbox" value="template_sastra.jpg" name="template_image" id="temp-6" class="hidden"
										<?php echo $event['event_image']=='template_sastra.jpg' ?'selected':'' ; ?> />
									</div>
									<div class="box-img-template col-md-15 col-sm-6">
										...
										<?php echo $event['event_image']=='template_senirupa.jpg' ?'selected':'' ; ?> />
									</div>
								</div>
						...
						<button id="submit" name="submit" value="submit" class="btn btn-orange btn-spek btn-square" type="submit">Submit</button>
					</div>
				</div>
			</form>
			<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
